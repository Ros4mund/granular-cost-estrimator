        ...
        with open(input_path, 'r') as f:
            for index, plan in enumerate(f.readlines()):
                ...
                if plan != 'null\n':
                    ...
                    # print(subplan['Plans'][0])
                    # if subplan['Node Type'] == 'Gather':
                    #     subplan = subplan['Plan'][0]
...
if __name__ == '__main__':
    feature_extractor(r'C:\Users\Jiahe Zhang\Desktop\CLEO project\TPCH\queryplan1.json',
                      r'C:\Users\Jiahe Zhang\Desktop\CLEO project\TPCH\queryoutput.json')
