...
def encode_train_plan_seq_save(path, parameters, batch_size=64, directory='C:/Users/Jiahe Zhang/Desktop/CLEO project/TPCH'):
    test_plans = []
...
def encode_test_plan_seq_save(path, parameters, batch_size=64, directory='C:/Users/Jiahe Zhang/Desktop/CLEO project/TPCH'):
    test_plans = []
    with open(path, 'r') as f:
        for idx, seq in enumerate(f.readlines()):
            plan = json.loads(seq)
