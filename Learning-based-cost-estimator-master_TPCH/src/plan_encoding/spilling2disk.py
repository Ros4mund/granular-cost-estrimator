...
def make_data_job(plans, parameters):
    ...
    for plan in plans:
        ...
        # print('operators_batch',operators_batch)
...
def save_data_job(plans, parameters, istest=False, batch_size=64, directory='C:/Users/Jiahe Zhang/Desktop/CLEO project/TPCH'):
    if istest:
        suffix = 'test_'
    else:
        suffix = ''
