...
def encode_node_job(node, parameters):
    ...
    ### Samples Ends
    has_condition = 0
    # print(parameters.columns_id.keys())
    if node != None:
        ...
        if operator == 'Materialize' or operator == 'BitmapAnd' or operator == 'Result':
            ...
            for key in node['sort_keys']:
                # print(key.shape)
                if key in parameters.columns_id.keys():
                    extra_info_inx = parameters.columns_id[key]
                    # print('extra info: ',extra_info_inx)
            ...
            print('c1', node['condition'])
            # print(condition1_vec)
    ...
    # print('condition1_vec', condition1_vec[0].shape)
