...
print(dataset)
print(dataset['part'].keys())
column2pos, indexes_id, tables_id, columns_id, physic_ops_id, compare_ops_id, bool_ops_id, table_names = prepare_dataset(
    dataset)
...
# print(sample)
feature_extractor(r'C:\Users\Jiahe Zhang\Desktop\CLEO project\TPCDS\queryplan1.json',
                  r'C:\Users\Jiahe Zhang\Desktop\CLEO project\TPCDS\query_output1.json')
